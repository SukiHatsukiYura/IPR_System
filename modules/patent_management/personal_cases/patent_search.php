...
<div class="module-panel">
    ...
    <form id="search-form" class="module-form" autocomplete="off">
        ...
        ?>
        <?php render_info_notice("个人案件查询（当前用户：" . $current_user_name . "）：只显示您作为处理人、项目负责人、业务人员或业务助理的专利案件", 'success', 'icon-search'); ?>
...
<script>
    (function() {
        ...
        btnEdit.onclick = function() {
            ...
            sessionStorage.setItem('patent_edit_source_submenu', '5');
