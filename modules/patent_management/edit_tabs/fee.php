            ...
            addSelectedFees: function() {
                ...
                document.querySelectorAll('#official-fees-list tr[data-template-id]').forEach(function(row) {
                    ...
                    if (checkbox && checkbox.checked) {
                        var feeData = {
                            fee_reduction_type: row.querySelector('.fee-reduction-type-cell').value,
                            currency: row.querySelector('.fee-currency-cell').value,
                            amount: parseFloat(row.querySelector('.fee-amount-cell').value) || 0,
                            quantity: parseInt(row.querySelector('.fee-quantity-cell').value) || 1,
                            actual_currency: row.querySelector('.fee-actual-currency-cell').value,
                            actual_amount: parseFloat(row.querySelector('.fee-actual-amount-cell').value) || 0,
                            receivable_date: row.querySelector('.fee-receivable-date-cell').value,
                            received_date: row.querySelector('.fee-received-date-cell').value
                        };
