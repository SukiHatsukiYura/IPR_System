...
// 验证版权是否存在
$copyright_stmt = $pdo->prepare("SELECT id, case_name FROM copyright_case_info WHERE id = ?");
...
<div class="module-panel">
    ...
    <div class="module-file-upload">
        ...
        <select id="file-type-select" class="module-input" style="width:120px; background-color: #fff;">
            ...
            <option value="作品样本">作品样本</option>
            <option value="权利证明">权利证明</option>
            <option value="身份证明">身份证明</option>
            <option value="委托书">委托书</option>
            <option value="说明文档">说明文档</option>
    ...
    <div class="module-btns" style="margin-top: 15px;">
        ...
        <button type="button" class="btn-mini filter-btn" data-type="作品样本">作品样本</button>
        <button type="button" class="btn-mini filter-btn" data-type="权利证明">权利证明</button>
        ...
        <button type="button" class="btn-mini filter-btn" data-type="说明文档">说明文档</button>
...
<script>
    (function() {
        ...
        var FILE_API_URL = 'modules/copyright_management/edit_tabs/file_api.php?copyright_id=' + copyrightId;
        var currentFileType = '';
        ...
        function uploadFile(fileType, fileInputId, fileNameInputId) {
            ...
            files.forEach(function(file, index) {
                ...
                formData.append('copyright_case_info_id', copyrightId);
        ...
        function renderFileList(fileType) {
            ...
            var params = 'action=list&copyright_case_info_id=' + copyrightId;
            if (fileType) {
