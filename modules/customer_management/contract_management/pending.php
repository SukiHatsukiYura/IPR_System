...
if (isset($_GET['ajax']) && $_GET['ajax'] == 1) {
    ...
    // 待处理条件：合同状态为"执行中"或"意外终止"
    $where[] = "(contract_status = '执行中' OR contract_status = '意外终止')";
    ...
    $html = '';
    if (empty($contracts)) {
        $html = '<tr><td colspan="9" style="text-align:center;padding:20px 0;">暂无待处理数据</td></tr>';
    } else {
...
<script>
    (function() {
        ...
        function loadContractData() {
            ...
            var requestUrl = baseUrl.replace('index.php', '') + 'modules/customer_management/contract_management/pending.php';
