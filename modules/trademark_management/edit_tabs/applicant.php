...
<script>
    (function() {
        ...
        var API_URL = 'modules/trademark_management/edit_tabs/applicant_api.php?trademark_id=' + trademarkId;
        var FILE_API_URL = 'modules/trademark_management/edit_tabs/applicant_file_upload.php?trademark_id=' + trademarkId;
        ...
        function uploadFile(fileType, fileInputId, fileNameInputId, listDivId, applicantId) {
            ...
            files.forEach(function(file, index) {
                ...
                formData.append('trademark_case_applicant_id', applicantId);
        ...
        function renderFileList(applicantId, fileType, listDivId) {
            ...
            xhr.send('action=list&trademark_case_applicant_id=' + applicantId + '&file_type=' + encodeURIComponent(fileType));
        }
