...
// 我的关注功能 - 商标管理/个人案件模块下的我的关注案件管理功能
...
<div class="module-panel">
    ...
    ?>
    <?php render_info_notice("我的关注（当前用户：" . $current_user_name . "）：只显示您关注的商标案件", 'success', 'icon-search'); ?>
...
<script>
    (function() {
        ...
        window.loadTrademarkData = function() {
            ...
            var requestUrl = baseUrl.replace('index.php', '') + 'modules/trademark_management/personal_cases/my_focus.php';
        ...
        btnEdit.onclick = function() {
            ...
            sessionStorage.setItem('trademark_edit_source_submenu', '3');
